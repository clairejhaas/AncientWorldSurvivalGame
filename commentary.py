...
def handle_room(location):
  ...
  if location == "start":
    ...
    if direction == "left":
      return "egypt_commentary"
    elif direction == "straight":
      return "greece_commentary"
    elif direction == "right":
      return "china_commentary"

  elif location == "egypt_commentary":
    print("")
    ...
    if option == "1":
      return "doctor_egyptian_commentary"
    else:
      return "farmer_egyptian_commentary"

  elif location == "doctor_egyptian_commentary":
  ...
  elif location == "farmer_egyptian_commentary":
