...
time.sleep(1)
print("View sources on github at 'https://github.com/clairejhaas/AncientWorldSurvivalGame'. Designed by @clairejhaas. ")
time.sleep(1)
...
if commentary == "yes":
    ...
    exec(open("game.py").read(), {"with_commentary": True, "hp": hp})
elif commentary == "no":
    print("Commentary mode: off.")
    exec(open("game.py").read(), {"with_commentary": False, "hp": hp})
